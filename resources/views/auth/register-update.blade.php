    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('users.update', $user->id) }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="contact_number" class="block mt-1 w-full" type="tel" name="contact_number" value="{{ $user->contact_number }}" pattern="[0-9]{3}[0-9]{4}[0-9]{3}" placeholder=""/>
            </div>
            <div class="mt-4">
            ...
            <div class="mt-4">
                ...
                <select id="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="role">
                    ...
                    <option {{ ($user->role == "Account Manager")? "selected" : "" }} value="Account Manager">Account Manager</option>
                </select>
            </div>
            <div class="mt-4">
                ...
                <select id="department" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="department">
                    <option {{ ($user->department == "Information Techonology")? "selected" : "" }} value="Information Techonology">Information Techonology</option>
                    <option {{ ($user->department == "Finance")? "selected" : "" }} value="Finance">Finance</option>
                    <option {{ ($user->department == "Marketing")? "selected" : "" }} value="Marketing">Marketing</option>
                    <option {{ ($user->department == "Human Resource")? "selected" : "" }} value="Human Resource">Human Resource</option>
                    <option {{ ($user->department == "Marketing")? "selected" : "" }} value="Marketing">Marketing</option>
                    <option {{ ($user->department == "Legal Department")? "selected" : "" }} value="Legal Department">Legal Department</option>
                </select>
                <div class="mt-4">
                    ...
                    <select id="designation" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="designation">
                        <option {{ ($user->designation == "Director")? "selected" : "" }} value="Director">Director</option>
                        <option {{ ($user->designation == "CEO")? "selected" : "" }} value="CEO">CEO</option>
                        <option {{ ($user->designation == "COO")? "selected" : "" }} value="COO">COO</option>
                        <option {{ ($user->designation == "CFO")? "selected" : "" }} value="CFO">CFO</option>
                        <option {{ ($user->designation == "CTO")? "selected" : "" }}  value="CTO">CTO</option>
                        <option {{ ($user->designation == "CMO")? "selected" : "" }} value="CMO">CMO</option>
                        <option {{ ($user->designation == "Manager")? "selected" : "" }} value="Manager">Manager</option>
                        <option {{ ($user->designation == "Employee")? "selected" : ""  }} value="Employee">Employee</option>
                    </select>
            </div>
              ...
              <div class="mt-4">
                ...
                <x-input id="personal_email_address" class="block mt-1 w-full" type="email" name="personal_email_address" value="{{ $user->personal_email_address }}" required />
            </div>
